<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"C:\LMAP\wwwroot\run\public/../application/admin\view\bugatti_forum\post_details.html";i:1557808066;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    $("#past").click(function () {
        ...
        $.ajax({
            url:"<?php echo url('pastPost'); ?>?post_id="+post_id,
            dateType:"json",
