<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/var/www/ZUAD_info_release/public/../application/admin_released/view/layout/layout_add.html";i:1546844148;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="container" style="width: 1300px">
    ...
    <div class="span3 divFlex">
        <div class="divpadding">
            ...
            <input type="text" class="span1" placeholder="宽度" id="slider-width" value="1920" />
            x
            <input type="text" class="span1" placeholder="高度" id="slider-height" value="1080" />
        </div>
        <div class="divpadding">
            <span style="position: relative; top: -5px;left:-4px;">预置页面尺寸：</span>
            <select id="selectpagesize" class="span1" style="width:126px;">
    ...
    <div class="span3 divFlex">
        ...
        <div>
            <label for="in-during">
                ...
                <input id="in-during" type="number" value="1" placeholder="(s)" class="input-mini" data-bind='during' data-trigger="focusout">
            </label>
        </div>
    </div>
    <div class="span3 divFlex">
    ...
    <div class="span2 divFlex" style="border:none;">
        <div class="divpadding">
            <button class="btn btn-success" onclick="isSave(this)" id="generate" style="padding:4px 30px;">
                保存
            </button>
        </div>
        <div class="divpadding">
...
<div class="wp" style="position: relative;left:0;">
    <div class="container tabs" style="display: flex;justify-content: stretch;">
        <div style="width: 180px;height: 50px;display: flex;justify-content: center;align-items: center;">
            <div class="spanitemleft" style="margin: 0px -10px;padding: 10px;">
                <a href="#" class="btn" id="add-slide">新建内页</a> &nbsp;
            </div>
            <div class="spanitemleft" style="margin: 0px -10px;padding: 10px;">
                <a href="#" class="btn" id="remove-slide">删除内页</a>  &nbsp;
            </div>
        </div>
    ...
    <div class="container slider" style="">
        <!-- The slider -->
        <div class="tab-content" id="slide-content" style="border: 10px solid #cecece;">
            <!-- Slide content with elements will be created here -->
        </div>

        <!--<div class="bindingDataList" style="width:400px;height:200px;display: inline-block;margin:0 30px;border:1px solid #ccc;padding: 10px;position: absolute;box-sizing: border-box;">-->
            <!--&lt;!&ndash;<form class="form-horizontal" name="device" id="device" method="post" action="<?php echo url('sendTask'); ?>">&ndash;&gt;-->
                    <!--<select data-placeholder="请选择设备" id="device_ids" name="device_ids[]" class="chosen-select" multiple style="width:370px;">-->
                        <!--<?php if(!empty($devices)): ?>-->
                        <!--<?php if(is_array($devices) || $devices instanceof \think\Collection || $devices instanceof \think\Paginator): if( count($devices)==0 ) : echo "" ;else: foreach($devices as $key=>$vo): ?>-->
                        ...
                        <!--<?php endif; ?>-->
                    <!--</select>-->
                <!--<button class="btn btn-success" onclick="isSave(this)" id="sendTask" style="padding:4px 30px;margin-top: 20px;width: 370px">-->
                    <!--下发节目-->
                <!--</button>-->
            <!--&lt;!&ndash;</form>&ndash;&gt;-->
        <!--</div>-->
        <div  style="width:470px;display:none;margin:0 20px;top:50px;border:1px solid #ccc;padding: 10px;position: absolute;box-sizing: border-box;">
            <!--<form id="uploadForm" enctype="multipart/form-data">-->
            <div class="bindingDataList" style="width:auto;display: inline-block;">

            </div>
            <!--</form>-->
            <div style="width:400px;display: none;margin:0 30px;padding: 10px;margin-left: -10px;margin-top: 50px;">
                <select data-placeholder="请选择设备" id="device_ids" name="device_ids[]" class="chosen-select" multiple style="width:370px;">
        ...
        <div id="modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="mod-label" aria-hidden="true">
            ...
            <div class="modal-body">
                <p>
                    页面名称:<input id="txtTitle" type="text" style="width: 300px;" />
        ...
        <div id="exitBox" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="mod-label" aria-hidden="true">
            ...
            <div class="modal-footer">
                ...
                <button class="btn" id="btnSave" onClick="javascript :history.back(-1);">
                    确认
                </button>
            </div>
        </div>
        ...
        <div id="mediaFileOptionsPage" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="mod-label" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <table>
                    <thead>
                    <tr style="text-align: center"><td>预览</td><td>名称</td><td>大小</td><td></td></tr>
                    </thead>
...
<script type="text/javascript">
    // var bind_data = <?php echo $template; ?>;
    ...
    var fontsizeList1 = <?php echo $template; ?>;
