<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/run1/public/../application/admin/view/feedback/index.html";i:1561017183;s:60:"/var/www/html/run1/application/admin/view/public/header.html";i:1539856994;s:60:"/var/www/html/run1/application/admin/view/public/footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        var columns = [
            {
                ...
                formatter : function (value, row, index) {
                    if (row.fileurl == ''){
                        return '<div style="width: 150px;margin: 0 auto;"><a href="#">无</a></div>'
                    } else {
