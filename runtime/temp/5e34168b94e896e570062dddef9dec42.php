<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/var/www/html/VacuumCup/public/../application/admin/view/join/release_index.html";i:1567676355;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('addRelease'); ?>"><button class="btn btn-outline btn-primary" type="button">发布信息</button></a>
                        </div>
                    </div>
                    <form name="list_sea" class="form-search" method="post" action="<?php echo url('release_index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="项目标题/联系方式/email/qq" />
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("release_index"); ?>', {page: curr || 1,key:key}, function(data){
    ...
    function delRelease(id){
        lunhui.confirm(id,'<?php echo url("delRelease"); ?>');
    }
    //编辑
