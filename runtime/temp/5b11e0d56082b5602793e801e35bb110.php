        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_User" id="add_User" method="post" action="<?php echo url('addUser'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="mobile" type="number" class="form-control" name="mobile" placeholder="请输入手机号">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">昵称：</label>
                            <div class="input-group col-sm-4">
                                <input id="nick" type="text" class="form-control" name="nick" placeholder="请输入昵称">
                            </div>
                        </div>
                        <div class="form-group">
