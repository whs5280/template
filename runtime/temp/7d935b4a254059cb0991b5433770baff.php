            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('addHonor'); ?>"><button class="btn btn-outline btn-primary" type="button">添加商品</button></a>
                    </div>
                </div>                                    
