<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/var/www/html/VacuumCup/public/../application/admin/view/honor/add_honor.html";i:1567676355;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_Honor" id="add_Honor" method="post" action="<?php echo url('addHonor'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" placeholder="请输入账号">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">内容描述：</label>
                            <div class="input-group col-sm-4">
                                <textarea id="descr" style=" width:100%; height:120px;" name="content_descr" placeholder="请输入描述"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">选择标题图片：</label>
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="title_img" >
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="text1" style="display: none; width:100%; height:200px;" name="content"></textarea>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function checkForm(){
            ...
            if( '' == $.trim($('#descr').val())){
                layer.msg('请输入描述',{icon:2,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
