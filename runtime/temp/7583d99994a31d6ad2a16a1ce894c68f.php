<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\LMAP\wwwroot\run\public/../application/admin\view\admin\admin_edit.html";i:1556270260;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="adminEdit" id="adminEdit" method="post" action="<?php echo url('adminEdit'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control m-b chosen-select" name="wechatUser_id" id="wechatUser">
                                    ...
                                    <?php if(!empty($wechatUsers)): if(is_array($wechatUsers) || $wechatUsers instanceof \think\Collection || $wechatUsers instanceof \think\Paginator): if( count($wechatUsers)==0 ) : echo "" ;else: foreach($wechatUsers as $key=>$vo): ?>
                                    <option value="<?php echo $vo['id']; ?>" <?php if($user['wechatUser_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['nickname']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                </select>
                            </div>
                        </div>
