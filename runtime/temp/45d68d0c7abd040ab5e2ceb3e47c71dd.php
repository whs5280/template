        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_Img" id="add_Img" method="post" action="<?php echo url('addImg'); ?>">
...
<script type="text/javascript">
    ...
    var path = $('#path');
    editor.customConfig.uploadImgServer = "<?php echo url('Upload/uploadGoodsImg'); ?>";
