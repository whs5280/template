<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"C:\LMAP\wwwroot\run\public/../application/admin\view\user1\index.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('addUser'); ?>"><button class="btn btn-outline btn-primary" type="button">添加用户</button></a>
                    </div>
                </div>                                    
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="输入需查询的用户账号/昵称/手机号" />   
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].sex}}</td>
                                <td>{{d[i].mobile}}</td>
                                <td>{{d[i].words_count}}</td>
                                <td>{{d[i].like_words_count}}</td>
                                <td>{{d[i].like_user_count}}</td>
                                <td>{{d[i].fans_count}}</td>
                                <td>
                                    {{# if(d[i].status==1){ }}
...
//删除用户
function delUser(id){
    lunhui.confirm(id,'<?php echo url("delUser"); ?>');
}

//用户用户
function userStatus(id){
    lunhui.updateStatus(id,"<?php echo url('userStatus'); ?>");
}
