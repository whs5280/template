<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/var/www/html/VacuumCup/public/../application/admin/view/homepage/advertise_index.html";i:1569832924;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('addAdvertise'); ?>"><button class="btn btn-outline btn-primary" type="button">添加广告</button></a>
                    </div>
                </div>                                    
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('advertise_index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="id/相关产品" />
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("advertise_index"); ?>', {page: curr || 1,key:key}, function(data){
...
function delAdvertise(id){
    lunhui.confirm(id,'<?php echo url("delAdvertise"); ?>');
}
