<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\LMAP\wwwroot\run\public/../application/admin\view\brand\edit_brand.html";i:1556293932;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="edit_brand" id="edit_brand" method="post" action="<?php echo url('edit_brand'); ?>">
                        <input type="hidden" name="id" value="<?php echo $brandData['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">品牌名称*：</label>
                            <div class="input-group col-sm-4">
                                <input id="brand_name" type="text" class="form-control" name="brand_name" value="<?php echo $brandData['name']; ?>" placeholder="请输入品牌名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">品牌标题：</label>
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" value="<?php echo $brandData['title']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio i-checks">
                                    <input type="radio" name='status' value="1" <?php if($brandData['status'] == 1): ?>checked<?php endif; ?>/>开启
                                    <input type="radio" name='status' value="0" <?php if($brandData['status'] == 0): ?>checked<?php endif; ?>/>停用&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="brand_img" name="brand_img" value="<?php echo $img; ?>">
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="float:left">选择图片</div>
                                <img id="img_data" class="img-circle" height="80px"  width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="/<?php echo $img; ?>"/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
