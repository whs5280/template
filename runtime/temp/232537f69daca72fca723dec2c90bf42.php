<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/var/www/html/VacuumCup/public/../application/admin/view/privates/order_index.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('Order_index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="制定人/昵称/手机号/邮箱" />
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("Order_index"); ?>', {page: curr || 1,key:key}, function(data){
    ...
    //删除
    function del(id){
        lunhui.confirm(id,'<?php echo url("delOrder"); ?>');
    }
</script>
</body>
</html>