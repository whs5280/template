<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"C:\LMAP\wwwroot\run\public/../application/admin\view\login.html";i:1555146940;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5" style="color:#fff">
            <form id="doLogin" name="doLogin" method="post" action="<?php echo url('doLogin'); ?>">
                <p class="m-t-md" id="err_msg">登录到超跑论坛后台</p>
    ...
    <div class="signup-footer">
        <div class="pull-left" style="color:#fff">
            &copy; 2019 超跑论坛后台管理系统 All Rights Reserved.
        </div>
    </div>
</div>
