<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/var/www/ZUAD_info_release/public/../application/admin_released/view/layout/user_data.html";i:1546480395;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/header.html";i:1539856994;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/footer.html";i:1539856994;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <?php if(!empty($template)): if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    ...
                                    <td class="project-title">
                                        <a href="#"><?php echo $template['医生姓名']; ?></a>
                                        <a href="#"><?php echo $template['护士姓名']; ?></a>
                                        <a href="#"><?php echo $template['管家姓名']; ?></a>

                                        <br/>
                                        <a href="#"><?php echo $vo['医生姓名']; ?></a>
                                        <a href="#"><?php echo $vo['护士姓名']; ?></a>
                                        <a href="#"><?php echo $vo['管家姓名']; ?></a>
                                    </td>
