                    ...
                    <form class="form-horizontal" name="Type" id="edit_Type" method="post" action="<?php echo url('editType'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <img id="img_data" class="img" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="/uploads/face/<?php echo $info['path']; ?>"/>
                            </div>
                        </div>
