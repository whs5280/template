<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"C:\LMAP\wwwroot\run\public/../application/admin\view\koenigsegg_news\news_comment.html";i:1556336153;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="pull-right">
                            ...
                            <button class="btn btn-white btn-xs" type="button">该评论作者：<?php echo $comment_comment['nickname']; ?></button>
                            <button class="btn btn-white btn-xs" type="button">回复</button>
                        ...
                        <div><?php echo $comment_comment['content']; ?></div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h2>评论：</h2>
                                <?php if(is_array($comment_comment_list) || $comment_comment_list instanceof \think\Collection || $comment_comment_list instanceof \think\Paginator): if( count($comment_comment_list)==0 ) : echo "" ;else: foreach($comment_comment_list as $key=>$v): ?>
