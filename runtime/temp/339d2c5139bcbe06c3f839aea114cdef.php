        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_Honor" id="add_Honor" method="post" action="<?php echo url('addRelease'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">项目名称：</label>
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" placeholder="请输入项目名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">联系方式：</label>
                            <div class="input-group col-sm-4">
                                <input id="mobile" type="text" class="form-control" name="mobile" placeholder="请输入联系方式">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">email：</label>
                            <div class="input-group col-sm-4">
                                <input id="email" type="text" class="form-control" name="email" placeholder="请输入email">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">qq：</label>
                            <div class="input-group col-sm-4">
                                <input id="qq" type="text" class="form-control" name="qq" placeholder="请输入qq">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function checkForm(){
            ...
            if( '' == $.trim($('#mobile').val())){
                layer.msg('请输入联系方式',{icon:2,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
            ...
            if( '' == $.trim($('#qq').val())){
                layer.msg('请输入qq',{icon:2,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
