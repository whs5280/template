        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="News" id="edit_News" method="post" action="<?php echo url('editNews'); ?>">
                        <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">项目名称：</label>
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" placeholder="请输入项目名称" value="<?php echo $data['title']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    var $text1 = $('#text1');
    var path = $('#path');
    editor.customConfig.uploadImgServer = "<?php echo url('Upload/uploadNewsImg'); ?>";
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#title').val())){
                layer.msg('请输入项目名',{icon:2,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
