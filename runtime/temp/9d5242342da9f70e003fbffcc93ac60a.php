<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/var/www/html/caiwu/public/../application/admin/view/config/index.html";i:1561356104;s:61:"/var/www/html/caiwu/application/admin/view/public/header.html";i:1539856994;s:61:"/var/www/html/caiwu/application/admin/view/public/footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="panel-heading">                     
                            <div class="panel-options">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a data-toggle="tab" href="#tab-5" aria-expanded="false">微信小程序配置</a></li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal">  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-sm-4">                                              
                                                ...
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 设置在网站底部显示的备案号，如“ 粤ICP备15002349号-1</span>
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                ...
                                <div id="tab-5" class="tab-pane">
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">AppKey：</label>
                                            <div class="input-group col-sm-4">
                                                <input type="text" class="form-control" name="config[wechat_appkey]" value="<?php echo $config['wechat_appkey']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 请前往微信公众平台平台查看AppKey</span>
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">AppSecret：</label>
                                            <div class="input-group col-sm-4">
                                                <input type="text" class="form-control" name="config[wechat_appsecret]" value="<?php echo $config['wechat_appsecret']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 请前往微信公众平台平台查看AppSecret</span>
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
