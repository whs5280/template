<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/var/www/ZUAD_info_release/public/../application/admin/view/menu/index.html";i:1546850084;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/header.html";i:1539856994;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/footer.html";i:1539856994;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                        ...
                                        <td>
                                            <?php if($v['status'] == 1): ?>
                                                <a class="red" href="javascript:;" onclick="rule_state(<?php echo $v['id']; ?>);">
                                                    <div id="zt1<?php echo $v['id']; ?>"><span class="label label-info">开启</span></div>
                                                </a>
                                            <?php else: ?>
                                                <a class="red" href="javascript:;" onclick="rule_state(<?php echo $v['id']; ?>);">
                                                    <div id="zt1<?php echo $v['id']; ?>"><span class="label label-danger">禁用</span></div>
                                                </a>
                                            <?php endif; ?> 
                                        </td>
