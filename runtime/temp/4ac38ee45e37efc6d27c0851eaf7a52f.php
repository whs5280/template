<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\PHPTutorial\WWW\VacuumCup\public/../application/admin/view/user/edit_user.html";i:1563939582;s:70:"D:\PHPTutorial\WWW\VacuumCup\application\admin\view\public\header.html";i:1539856994;s:70:"D:\PHPTutorial\WWW\VacuumCup\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="user" id="edit_user" method="post" action="<?php echo url('editUser'); ?>">
                        <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">用户名：</label>
                            <div class="input-group col-sm-4">
                                <input id="username" type="text" class="form-control" name="username" value="<?php echo $user['username']; ?>" placeholder="请输入用户名">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">昵称：</label>
                            <div class="input-group col-sm-4">
                                <input id="nick" type="text" class="form-control" name="nick" value="<?php echo $user['nick']; ?>" placeholder="请输入昵称">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="mobile" type="number" class="form-control" name="mobile" value="<?php echo $user['mobile']; ?>" placeholder="请输入手机号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <div class="radio i-checks">
                                    ...
                                    <input type="radio" name='sex' value="2" <?php if($user['sex'] == 0): ?>checked<?php endif; ?>/>女&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <div class="radio i-checks">
                                    <input type="radio" name='status' value="1" <?php if($user['status'] == 1): ?>checked<?php endif; ?>/>启用&nbsp;&nbsp;
                                    <input type="radio" name='status' value="0" <?php if($user['status'] == 0): ?>checked<?php endif; ?>/>禁用&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                        <!--<div class="form-group">-->
