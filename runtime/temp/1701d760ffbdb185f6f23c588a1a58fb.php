                    ...
                    <form class="form-horizontal" name="add_Honor" id="add_Honor" method="post" action="<?php echo url('addHonor'); ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="title" placeholder="请输入账号">
                            </div>
                        </div>
                        <div class="form-group">
