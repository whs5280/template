<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/var/www/html/VacuumCup/public/../application/admin/view/goods/edit_type.html";i:1567676355;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="Type" id="edit_Type" method="post" action="<?php echo url('editType'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="path" value="<?php echo $info['path']; ?>">
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="float:left">选择图片</div>
                                <img id="img_data" class="img" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="<?php echo $info['path']; ?>"/>
                            </div>
                        </div>
