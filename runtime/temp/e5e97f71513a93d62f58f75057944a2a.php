<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"C:\LMAP\wwwroot\run\public/../application/admin\view\we_chat_user\add_user.html";i:1552362070;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_member" id="add_member" method="post" action="<?php echo url('addUser'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="mobile" type="text" class="form-control" name="mobile" placeholder="请输入联系电话">
...
<script type="text/javascript">
    ...
    var uploader = WebUploader.create({
        ...
        server: "<?php echo url('Upload/uploadWechatFace'); ?>",// 文件接收服务端。
        ...
        'onUploadSuccess': function(file, data, response) {
            ...
            $("#img_data").attr('src', '/uploads/wechat/face/' + data._raw).show();
        }
    });
