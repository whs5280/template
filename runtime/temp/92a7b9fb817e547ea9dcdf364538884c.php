<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/run/public/../application/admin/view/admin/admin_add.html";i:1560578605;s:59:"/var/www/html/run/application/admin/view/public/header.html";i:1539856994;s:59:"/var/www/html/run/application/admin/view/public/footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="adminAdd" id="adminAdd" method="post" action="<?php echo url('adminAdd'); ?>">
...
<!--                                    <?php if(!empty($wechatUsers)): ?>-->
<!--                                    <?php if(is_array($wechatUsers) || $wechatUsers instanceof \think\Collection || $wechatUsers instanceof \think\Paginator): if( count($wechatUsers)==0 ) : echo "" ;else: foreach($wechatUsers as $key=>$vo): ?>-->
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function checkForm(){
            ...
            if( '' == $.trim($('#post').val())){
                layer.msg('请输入岗位',{icon:2,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
            // if( '' == $.trim($('#wechatUser').val())){
            //     layer.msg('请选择关联的微信小程序用户',{icon:2,time:1500,shade: 0.1}, function(index){
            //         layer.close(index);
            //     });
            //     return false;
            // }
