<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/var/www/html/VacuumCup/public/../application/admin/view/honor/index.html";i:1569377472;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('addHonor'); ?>"><button class="btn btn-outline btn-primary" type="button">添加荣誉</button></a>
                    </div>
                </div>                                    
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" onclick="editHonor({{d[i].id}})" class="btn btn-primary btn-outline btn-xs">
                                        <i class="fa fa-paste"></i> 编辑
                                    </a>&nbsp;&nbsp;
                                    <a href="javascript:;" onclick="delHonor({{d[i].id}})" class="btn btn-danger btn-outline btn-xs">
...
function editHonor(id){
    location.href = './editHonor/id/'+id+'.html';
}

//删除
function delHonor(id){
    lunhui.confirm(id,'<?php echo url("delHonor"); ?>');
}
//详情
