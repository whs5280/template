<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/var/www/ZUAD_info_release/public/../application/admin/view/role/index.html";i:1546849894;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/header.html";i:1539856994;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/footer.html";i:1539856994;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <tr class="long-td">
                                    ...
                                    <td>
                                        {{# if(d[i].id!==1){ }}
                                            ...
                                            <a href="javascript:;" onclick="dataQx({{d[i].id}})" class="btn btn-danger btn-outline btn-xs">
                                                <i class="fa fa-paste"></i> 数据权限</a>&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    function dataQx(id) {
        window.location.href = "<?php echo url('dataQx'); ?>"+'?id='+id;
    }
</script>
</body>
</html>
