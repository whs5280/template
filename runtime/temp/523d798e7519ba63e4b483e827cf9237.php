<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"C:\phpStudy\PHPTutorial\WWW\VacuumCup\public/../application/admin/view/homepage/title_edit.html";i:1565420953;s:79:"C:\phpStudy\PHPTutorial\WWW\VacuumCup\application\admin\view\public\header.html";i:1564540065;s:79:"C:\phpStudy\PHPTutorial\WWW\VacuumCup\application\admin\view\public\footer.html";i:1564540064;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="titleEdit" id="titleEdit" method="post" action="<?php echo url('titleEdit'); ?>">
                        <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">主标题：</label>
                            <div class="input-group col-sm-4">
                                <textarea id="main_title" type="text" class="form-control" name="main_title" ><?php echo $data['main_title']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">副标题：</label>
                            <div class="input-group col-sm-4">
                                <textarea id="vice_title" type="text" class="form-control" name="vice_title" ><?php echo $data['vice_title']; ?></textarea>
                            </div>
                        </div>
        ...
        function complete(data){
            if(data.code==1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('Homepage/title_index'); ?>";
                });
            }else{
