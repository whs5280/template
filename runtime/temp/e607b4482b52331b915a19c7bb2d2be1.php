<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/var/www/info_release/public/../application/admin/view/devicelog/device_log.html";i:1539857006;s:63:"/var/www/info_release/application/admin/view/public/header.html";i:1539856994;s:63:"/var/www/info_release/application/admin/view/public/footer.html";i:1539856994;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">                                             
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('device_log'); ?>">
                        <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("devicelog/device_log"); ?>', {page: curr || 1,key:key}, function(data){
