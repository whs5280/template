<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\LMAP\wwwroot\run\public/../application/admin\view\user\edit_user.html";i:1539856996;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="edit_member" id="edit_member" method="post" action="<?php echo url('editUser'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <div class="radio i-checks">
                                    <input type="radio" name='status' value="1" <?php if($member['status'] == 1): ?>checked<?php endif; ?>/>启用&nbsp;&nbsp;
                                    <input type="radio" name='status' value="0" <?php if($member['status'] == 0): ?>checked<?php endif; ?>/>禁用&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
