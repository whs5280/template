<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/var/www/html/VacuumCup/public/../application/admin/view/goods/edit_goods.html";i:1567676355;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="Goods" id="edit_Goods" method="post" action="<?php echo url('editGoods'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" value="<?php echo $goods['path']; ?>" name="path" >
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="float:left">选择图片</div>
                                <img id="img_data" class="img" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="<?php echo $goods['path']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
