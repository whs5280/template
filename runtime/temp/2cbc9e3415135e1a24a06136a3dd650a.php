<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"C:\phpStudy\PHPTutorial\WWW\VacuumCup\public/../application/admin/view/news/add_news.html";i:1565262987;s:79:"C:\phpStudy\PHPTutorial\WWW\VacuumCup\application\admin\view\public\header.html";i:1564540065;s:79:"C:\phpStudy\PHPTutorial\WWW\VacuumCup\application\admin\view\public\footer.html";i:1564540064;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_News" id="add_News" method="post" action="<?php echo url('addNews'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <textarea id="content_descr" style=" width:100%; height:120px;" name="content_descr" placeholder="请输入描述"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    var uploader = WebUploader.create({
        ...
        server: "<?php echo url('Upload/uploadNewsTitle'); ?>",// 文件接收服务端。
