                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].price}}</td>
                                <td>{{d[i].num}}</td>
                                <td><img id="img_data" class="img" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="/uploads/goods/{{d[i].path}}"/></td>
