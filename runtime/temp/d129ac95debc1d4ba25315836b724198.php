<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/var/www/html/run1/public/../application/admin/view/project/topic.html";i:1561016773;s:60:"/var/www/html/run1/application/admin/view/public/header.html";i:1539856994;s:60:"/var/www/html/run1/application/admin/view/public/footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="topic" id="topic" method="post" action="topic">
...
<!--                                <label class="col-sm-3 control-label" style="color: blue;"><?php echo $projectInfo['pname']; ?></label>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <?php if(!(empty($users) || (($users instanceof \think\Collection || $users instanceof \think\Paginator ) && $users->isEmpty()))): if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): if( count($users)==0 ) : echo "" ;else: foreach($users as $key=>$vo): if($vo['id'] == $projectInfo['assit']): ?>
...
<!--                                <label class="col-sm-3 control-label" style="color: blue;"><?php echo $projectInfo['htstarttime']; ?></label>-->
                                <input type="text" class="form-control" value="<?php echo date('Y-m-d',$projectInfo['htstarttime']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
...
<!--                                <label class="col-sm-3 control-label" style="color: blue;"><?php echo $projectInfo['htendtime']; ?></label>-->
                                <input type="text" class="form-control" value="<?php echo date('Y-m-d',$projectInfo['htendtime']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <!--                                <label class="col-sm-3 control-label" style="color: blue;"><?php echo $projectInfo['htendtime']; ?></label>-->
                                <input type="text" class="form-control" id="start" name="starttime" placeholder="项目启动日期">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <!--                                <label class="col-sm-3 control-label" style="color: blue;"><?php echo $projectInfo['htendtime']; ?></label>-->
                                <input type="text" class="form-control" id="end" name="limitedtime" placeholder="项目启动日期">
                            </div>
                        </div>
                        <div class="form-group">
...
<!--                                <input id="name" type="text" class="form-control" name="name" placeholder="请输入项目名称">-->
                        ...
                        <div id="addPerson">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">项目参与人 ：</label>
                                <div class="col-sm-3" id="users">
                                    <select class="form-control" name="user_id[]">
                                        <option value="0">请选择参与人</option>
                                        <?php if(!(empty($users) || (($users instanceof \think\Collection || $users instanceof \think\Paginator ) && $users->isEmpty()))): if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): if( count($users)==0 ) : echo "" ;else: foreach($users as $key=>$vo): ?>
                                        <option value="<?php echo $vo['id']; ?>"><?php echo $vo['post']; ?>：<?php echo $vo['real_name']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                    </select>
                                </div>
                                <div class="col-sm-3">
                                    <a onclick="addPer()" class="layui-btn">加多一条</a>
                                </div>
                            </div>
                        </div>
