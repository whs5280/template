                    ...
                    <form class="form-horizontal" name="Goods" id="edit_Goods" method="post" action="<?php echo url('editGoods'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <img id="img_data" class="img" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="/uploads/face/<?php echo $goods['path']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
