<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"/var/www/ZUAD_info_release/public/../application/admin_released/view/layout/device_list.html";i:1546356838;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/header.html";i:1539856994;s:68:"/var/www/ZUAD_info_release/application/admin/view/public/footer.html";i:1539856994;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal" name="device_ids" id="devices" method="post" action="<?php echo url('sendTask',['id'=>$id]); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">设备：</label>
                            <div class="input-group col-sm-4">
                                <select data-placeholder="请选择设备" id="device_ids" name="ids[]" class="chosen-select" multiple style="width:370px;">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-3">
                                <button class="btn btn-primary" type="submit"><i class="fa fa-save"></i> 下发</button>&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#device_ids').val())){
                layer.msg('请选择设备',{icon:2,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
