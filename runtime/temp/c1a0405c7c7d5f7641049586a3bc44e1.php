<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/VacuumCup/public/../application/admin/view/join/index.html";i:1567676355;s:65:"/var/www/html/VacuumCup/application/admin/view/public/header.html";i:1567676356;s:65:"/var/www/html/VacuumCup/application/admin/view/public/footer.html";i:1567676356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="公司名称/联系方式/地址/email/qq" />
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" onclick="delJoin({{d[i].id}})" class="btn btn-danger btn-outline btn-xs">
...
//删除商品
function delJoin(id){
    lunhui.confirm(id,'<?php echo url("delJoin"); ?>');
}
//详情
