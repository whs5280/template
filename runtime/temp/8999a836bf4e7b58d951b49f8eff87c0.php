<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\LMAP\wwwroot\run\public/../application/admin\view\mc_laren_news\edit_news.html";i:1556292054;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="editNews" id="editNews" method="post" action="editNews">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" value="<?php echo $news_info['title']; ?>" placeholder="请输入新闻标题">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="label" type="text" class="form-control" name="label" value="<?php echo $news_info['label']; ?>" placeholder="新闻标签">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <div id="eg">
                                    <textarea id="content" class="click2edit wrapper" name="content" ><?php echo $news_info['content']; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio i-checks">
                                    <input type="radio" name='status' value="1" <?php if($news_info['status'] == 1): ?> checked="checked"<?php endif; ?>/>启用&nbsp;&nbsp;
                                    <input type="radio" name='status' value="0" <?php if($news_info['status'] == 0): ?> checked="checked"<?php endif; ?>/>禁用&nbsp;
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
