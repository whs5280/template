                    ...
                    <form class="form-horizontal" name="Honor" id="edit_Honor" method="post" action="<?php echo url('editHonor'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" value="<?php echo $data['title']; ?>" name="title" placeholder="请输日标题">
                            </div>
                        </div>
                        <div class="form-group">
