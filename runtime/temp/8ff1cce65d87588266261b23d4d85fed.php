                    ...
                    <form class="form-horizontal" name="add_Goods" id="add_Goods" method="post" action="<?php echo url('addGoods'); ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="name" placeholder="请输入账号">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="price" type="number" class="form-control" name="price" placeholder="请输入价格，小数点两位">
                            </div>
                        </div>
                        <div class="form-group">
