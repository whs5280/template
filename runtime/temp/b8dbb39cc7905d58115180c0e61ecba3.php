<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"C:\LMAP\wwwroot\run\public/../application/admin\view\lamborghini_forum\release_post.html";i:1554781194;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\header.html";i:1539856994;s:61:"C:\LMAP\wwwroot\run\application\admin\view\public\footer.html";i:1551516328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="releasePost" id="releasePost" method="post" action="releasePost">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <textarea id="content" name="content" rows="10" cols="100" placeholder="请输入内容"></textarea>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="post_img_list" id="post_img_list">
                        <input type="hidden" name="post_img_size" id="post_img_size">
